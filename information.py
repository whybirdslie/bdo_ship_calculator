...
from translations_de import info_de
...
def gen_info(language='en'):
    ...
    ret += P(translate("More information can be found", language) + " " + A(translate("at this spreadsheet", language), href="https://docs.google.com/document/d/1basknMfrfcH6AzJD9PkzeUunqrIGTuS6SfXPf3a7pso/preview", target="_blank") + " " + translate("or", language) + " " + A(translate("these patch notes", language), href="https://www.blackdesertonline.com/news/view/3216", target="_blank"))
